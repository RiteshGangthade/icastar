...
public class AdminJobManagementController {
    ...
    public ResponseEntity<Map<String, Object>> updateJobPost(@PathVariable Long jobId, @RequestBody UpdateJobPostDto updateDto) {
        ...
        try {
            ...
            return buildErrorResponse("Failed to update job post: " + e.getMessage());
        }
    }

    // Merged from AdminJobController
    @DeleteMapping("/{jobId}")
    public ResponseEntity<Map<String, Object>> deleteJobPost(@PathVariable Long jobId) {
        ...
        try {
            ...
            return buildErrorResponse("Failed to delete job post: " + e.getMessage());
        }
    }
