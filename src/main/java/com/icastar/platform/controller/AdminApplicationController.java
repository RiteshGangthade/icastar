...
public class AdminApplicationController {
    ...
    public ResponseEntity<Page<JobApplicationDto>> getAllApplications(
        ...
        log.info("Admin fetching applications - page: {}, size: {}, sortBy: {}, sortDir: {}, status: {}, jobPostId: {}, artistId: {}, recruiterId: {}", 
                page, size, sortBy, sortDir, status, jobPostId, artistId, recruiterId);
        ...
        if (jobPostId != null) {
            applications = jobApplicationService.findByJobPost(jobPostId, pageable);
