...
//            boolean isOtpVerified = otpService.verifyOtp(request.getMobile(), request.getEmail(), "000000", Otp.OtpType.REGISTRATION);
//            if (!isOtpVerified) {
//                Map<String, Object> response = new HashMap<>();
//                response.put("success", false);
//                response.put("message", "Please verify your mobile number first");
//                return ResponseEntity.badRequest().body(response);
//            }
//
//            // Create user
